...
int main() {
	...
	uint64_t hbm[sizeof(Node) * MEM_SIZE / sizeof(uint64_t)];
	uint64_t req_buffer[sizeof(Request) * 0x100 / sizeof(uint64_t)];
	uint64_t resp_buffer[sizeof(Response) * 0x100 / sizeof(uint64_t)];
