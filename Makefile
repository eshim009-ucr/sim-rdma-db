...
$(TEMP_DIR)/krnl.xo: src/sm_insert.cpp src/krnl.cpp src/core/node.c src/core/insert.c src/core/search.c src/core/tree-helpers.c src/core/insert-helpers.c src/core/memory.c src/core/split.c src/core/operations.c src/sm_operations.cpp src/ramstream.cpp src/rdma.cpp src/sm_search.cpp
	mkdir -p $(TEMP_DIR)
